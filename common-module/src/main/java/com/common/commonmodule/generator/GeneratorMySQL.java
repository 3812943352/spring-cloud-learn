 ...
 */
package com.common.commonmodule.generator;
...
public class GeneratorMySQL {
     ...
     * 作者
     */
    public static final String AUTHOR = "王博";
    /**
     * java代码保存目录
     */
//    public static final String SAVE_PATH = System.getProperty("user.dir") + "/src/main/java";
    public static final String SAVE_PATH = "data-generator";
    /**
     * xml保存目录
     */
    public static final String XML_SAVE_PATH = "data-generator";
    /**
     * 保存到包下面
     */
    public static final String PACKAGE = "org.learning";
    /**
     * 要生成的表
     */
