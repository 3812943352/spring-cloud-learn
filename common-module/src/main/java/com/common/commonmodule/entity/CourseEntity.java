 ...
 * @LastEditTime: 2025-04-03 13:09:24
 * @FilePath: common-module/src/main/java/com/common/commonmodule/entity/CourseEntity.java
 * @Description: 这是默认设置, 可以在设置》工具》File Description中进行配置
 */
package com.common.commonmodule.entity;
